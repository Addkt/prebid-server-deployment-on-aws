...
MEMORY_TARGET_UTILIZATION_PCT = 60
REQUESTS_PER_TARGET = 2500
TASK_MIN_CAPACITY = 1
TASK_MAX_CAPACITY = 300

FARGATE_RESERVED_WEIGHT = 1
FARGATE_SPOT_WEIGHT = 10
...
# CloudFront settings
SSL_CERTIFICATE_ARN = "arn:aws:acm:us-east-1:077405089142:certificate/fe0f19cb-b93d-4746-90e4-fc2e54a7d87a"
DOMAIN_NAMES = ["unwind-s2s.lngtd.com"]